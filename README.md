...
| [`biomedical-cell-segmentation`](./biomedical-cell-segmentation) | Cell/nucleus instance segmentation | U-Net (foreground + boundary) trained from scratch, watershed splitting, per-cell morphology stats |
